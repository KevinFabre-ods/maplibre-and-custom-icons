...
function LayerCircleForm({ handleChange, ...form }) {
  return (
    <>
      ...
      <p>
        - Active dot (on click): border radius is 50
        <br />
        <br />
        We can handle active dot (click) and hovered dot.
        <br />
        <br />
        What style can be changed for active or hovere dot ? All{" "}
        <a
          href="https://maplibre.org/maplibre-style-spec/layers/#circle"
          target="_blank"
          rel="noopener noreferrer"
